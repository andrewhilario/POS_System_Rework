...
urlpatterns = [
    ...
    #Categories
    path('store/<slug:store_slug>/categories/', views.categories, name="categories"),
    path('store/<slug:store_slug>/categories/add/', views.add_category, name="add_category"),
    path('store/<slug:store_slug>/categories/edit/<slug:category_slug>', views.edit_category, name="edit_category"),
    path('store/<slug:store_slug>/categories/delete/<slug:category_slug>', views.delete_category, name="delete_category"),
    #Point of Sales
    ...
    path("store/<slug:store_slug>/products/add/", views.add_product, name="add_product"),
    path("store/<slug:store_slug>/products/edit/<slug:product_slug>/", views.edit_product, name="edit_product"),
    path("store/<slug:store_slug>/products/delete/<slug:product_slug>/", views.delete_product, name="delete_product"),
    # Coming Soon
